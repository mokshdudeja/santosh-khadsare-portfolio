        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-3">
                  <div className="w-12 h-12 bg-purple-600/10 rounded-lg flex items-center justify-center">
                    <div className="w-6 h-6 border-2 border-purple-600"></div>
                  </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden border border-white/10 shadow-xl hover:shadow-2xl transition-shadow">
                <img 
              ...
              {/* Floating Badge */}
              <div className="absolute -bottom-6 -right-6 bg-zinc-900 border border-white/20 rounded-lg p-4 shadow-xl hover:shadow-2xl transition-shadow">
